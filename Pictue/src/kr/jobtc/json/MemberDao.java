			...
			if(rs.next()) {
				data = String.format(
						"{'id' : '%s', 'fn' : '%s', 'em' : '%s', 'ph' : '%s', 'did' : '%s', 'mid' : '%s', 'jid' : '%s'}",
							rs.getInt("employee_id"),rs.getString("first_name"),rs.getString("email"),rs.getString("phone_number"),rs.getString("department_id"),rs.getString("manager_id"),rs.getString("job_id")
						);
