...
<body>
    	...
    	<div class = 'intro_doc'>
			...
			<ol>
				<li>저작권법에 준하지않은 문서</li>
				<li>같은 게시글을 연달아 작성을 한 문서</li>
				<li>게시판의 목적을 벗어난 문서</li>
			</ol>
    	</div>
    	...
    	<div class = 'intro_doc'>
			...
			<ol>
				<li>편집 제한: 문서의 삭제와 이동을 포함하는 모든 편집을 제한</li>
				<li>삭제 제한: 문서의 삭제를 제한</li>
				<li>이동 제한: 문서의 표제어 변경을 제한</li>
			</ol>
